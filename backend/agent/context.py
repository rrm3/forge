...
_BASE_PROMPT = (
    ...
    "## App Navigation\n"
    "The app has these sections, all accessible from the left sidebar:\n"
    "* **Home** - The main screen with four actions: Share a Tip or Trick, "
    "I'm Stuck, Brainstorm an Opportunity, and End-of-Day Wrap-up.\n"
    "* **Ideas to Explore** - The user's idea board. Ideas captured from brainstorm "
    "and chat conversations appear here. Users can view, edit, and track status.\n"
    "* **Tips & Tricks** - A company-wide gallery where users browse and vote on tips "
